...
f = "Data/polystyrene" # .tsv data file
...
r = p.add_run()
r.add_picture("Figures/GitHub_Logo.png", width = Inches(2))
p.alignment = WD_ALIGN_PARAGRAPH.RIGHT

p = footer.paragraphs[0]
r = p.add_run()
r.text = "Experimental report\tminiRaman SN" + str(sn) + "\t"
...
# add heading
document.add_heading('Experimental Report', 0)
...
# save document
document.save(str(today)+"_experimental_report_" + str(sn)+ ".docx")